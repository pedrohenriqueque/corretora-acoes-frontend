  ...
  <div class="min-h-screen bg-black text-white flex flex-col font-sans antialiased">
    ...
    <div class="border-b border-zinc-900 bg-[#050706] px-6 py-5">
      <div class="max-w-6xl mx-auto flex items-center justify-between gap-6">
        ...
        <!-- Action buttons -->
        <div class="flex items-center gap-3">
          <button id="btn-simular-deposito" @click="abrirModalDeposito"
          ...
          <button id="btn-simular-retirada" @click="abrirModalRetirada"
        ...
        <table class="w-full text-sm">
          <thead>
            <tr class="border-b border-zinc-800 bg-zinc-950/60">
              <th
                class="text-left px-5 py-3.5 text-xs font-bold text-zinc-500 uppercase tracking-wider whitespace-nowrap">
                Data / Hora</th>
              <th class="text-left px-5 py-3.5 text-xs font-bold text-zinc-500 uppercase tracking-wider">Descrição do
                Evento</th>
          ...
          <tbody>
            <tr v-for="(lancamento, index) in lancamentosExibidos" :key="lancamento.id ?? index"
    ...
    <ModalSimularLancamento :mostrar="mostrarModal" :tipo="tipoModal" @fechar="mostrarModal = false"
